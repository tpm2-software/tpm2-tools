...
SAVE_TYPE(TPM2B_TIMEOUT, timeout)
LOAD_TYPE(TPM2B_TIMEOUT, timeout)

SAVE_TYPE(TPM2B_NAME, name)
LOAD_TYPE(TPM2B_NAME, name)

SAVE_TYPE(TPM2B_NONCE, nonce)
LOAD_TYPE(TPM2B_NONCE, nonce)
