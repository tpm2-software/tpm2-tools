...
static tool_rc tpm2_policypassword_build(ESYS_CONTEXT *ectx) {

    tool_rc rc = tpm2_policy_build_policypassword(ectx, ctx.session,
...
static tool_rc tpm2_tool_onrun(ESYS_CONTEXT *ectx, tpm2_option_flags flags) {
     ...
     */
    rc = tpm2_policypassword_build(ectx);
    if (rc != tool_rc_success) {
        return rc;
    }
...
TPM2_TOOL_REGISTER("policypassword", tpm2_tool_onstart, tpm2_tool_onrun,
